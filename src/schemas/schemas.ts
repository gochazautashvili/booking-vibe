...
export const FormSchema = z.object({
  ...
  locationDescription: z.string().min(10, {
    message: "LocationDescription must be atleast 10 characters long",
  }),
...
export const RoomFormSchema = z.object({
  ...
  mountineView: z.boolean().optional(),
